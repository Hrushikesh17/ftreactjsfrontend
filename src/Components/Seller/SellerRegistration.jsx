  ...
  const handleSubmit = async (e) => {
    ...
    const sellerData = {
      ...
      user: {
        ...
        role: "SELLER", // Role set as SELLER by default
      },
    };

    try {
      const response = await axios.post(`${API_BASE_URL}/api/sellers/register`, sellerData);
      console.log('Registration successful:', response.data);
      setSuccessMessage('Registration successful! Redirecting to the login form...');
      setTimeout(() => {
  ...
  return (
    <StyledWrapper>
      <div className="form">
        ...
        <div className="subtitle">Create your seller account</div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="input-container ic1">
            <input placeholder="" type="text" className="input" ref={shopNameRef} />
            <div className="cut" />
            <label className="iLabel" htmlFor="shopName">Shop Name</label>
          </div>

          <div className="input-container ic2">
            <input placeholder="" type="text" className="input" ref={nameRef} />
            <div className="cut cut-short" />
            <label className="iLabel" htmlFor="name">Name</label>
          </div>
          ...
          <div className="input-container ic2">
            ...
            <div className="cut cut-short" />
            <label className="iLabel" htmlFor="address">Address</label>
          </div>

          <div className="input-container ic2">
            <input placeholder="" type="text" className="input" ref={phoneNumberRef} />
            <div className="cut cut-short" />
            <label className="iLabel" htmlFor="phoneNumber">Phone Number</label>
          </div>
